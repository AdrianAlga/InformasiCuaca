...
searchButton.addEventListener('click', function() {
    ...
    fetch("https://api.openweathermap.org/data/2.5/weather?q="+inputKeyword.value+"&appid=891b409dd9a3fd65598abc9a8f2d740e&units=metric")
        ...
        .then(response => {
            ...
            result.innerHTML = `<h2 style="margin-bottom: 15px;">${response.name}, ${response.sys.country}</h2>
                                ...
                                <p style="margin-bottom: 17px;">Suhu dari ${response.main.temp_min}°С - ${response.main.temp_max}°С</p>
                                <h5>Kecepatan Angin : ${response.wind.speed} m/s</h5>
                                <h5 style="margin-bottom: 17px;">Kuantitas Awan : ${response.clouds.all}%</h5>
